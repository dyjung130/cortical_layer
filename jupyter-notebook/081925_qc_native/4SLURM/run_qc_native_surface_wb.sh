...
PYTHON_SCRIPT="/ocean/projects/bio220042p/djung2/jupyter-notebook/082625_exvivo_quality_control/qc/quality_control_native_surface_slurm_wb.py"
...
if [[ ! -f "${SUBJECT_DIR}/mri/native.nii" ]]; then
    echo "ERROR: Required file not found: ${SUBJECT_DIR}/mri/native.nii"
    exit 1
else
